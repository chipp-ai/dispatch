      ...
      <div className="px-2 pb-1 space-y-0.5">
        ...
        {onOpenGuide && (
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 md:py-1.5 rounded-md text-[14px] md:text-[13px] text-[#888] hover:bg-[#1a1a1a] hover:text-[#ccc] transition-colors"
          >
            <span className="w-5 h-5 md:w-4 md:h-4"><GuideStepperIcon /></span>
            <span>Guide</span>
          </button>
        )}
      </div>
