<script lang="ts">
  ...
  import { BadgeCheck, ExternalLink, CreditCard, Wallet, Receipt, TrendingUp, Info, CheckCircle, Sparkles, Shield, Zap, ArrowRight, Loader2 } from "lucide-svelte";
...
<div class="page-header">
  <h1>Subscription</h1>
  <p class="page-subtitle">Manage your plan and subscription</p>
</div>
